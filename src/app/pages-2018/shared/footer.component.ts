                ...
                <div class="row">
                        ...
                        <address class="font-opensans">
                            <ul>
                                ...
                                <li class="footer-sprite email">
                                    <a href="mailto:info@iahsp.com">info@iahsp.com</a>
                                </li>
                            </ul>
                        </address>
                    ...
                    <div class="column logo col-md-4 text-center">
                        <div class="logo-content">
                            <img class="center-block img-responsive" src="https://d3oaxt0bwkjnjn.cloudfront.net/iahspconexpo/images/logo-iahsp-footer.png" width="350" alt="" />
                        </div>
                    </div><!-- /FOOTER LOGO -->
