  ...
  template: `
    ...
    <section class="padding100">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-center">2019 IAHSP CONFERENCE & EXPO</h2>
          </div>
          ...
          <div class="col-md-5">            
            <p>The 2019 IAHSP<sup>®</sup> Conference and EXPO - ROCK Your Business in Music City- brings together top Home Staging Industry business owners and 
